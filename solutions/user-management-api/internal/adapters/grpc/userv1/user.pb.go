...
const file_api_proto_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x1capi/proto/user/v1/user.proto\x12\auser.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"Y\n" +
	...
	"\n" +
	"created_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt2y\n" +
	"\vUserService\x127\n" +
	"\n" +
	"CreateUser\x12\x1a.user.v1.CreateUserRequest\x1a\r.user.v1.User\x121\n" +
	"\aGetUser\x12\x17.user.v1.GetUserRequest\x1a\r.user.v1.UserBnZlgithub.com/neverholiday/backend-challenge/solutions/user-management-api/internal/adapters/grpc/userv1;userv1b\x06proto3"
...
var file_api_proto_user_v1_user_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_api_proto_user_v1_user_proto_depIdxs = []int32{
	...
	2, // 3: user.v1.UserService.CreateUser:output_type -> user.v1.User
	2, // 4: user.v1.UserService.GetUser:output_type -> user.v1.User
